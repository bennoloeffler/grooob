(ns grooob.model.model
  (:require
    ...
    [belib.spec :as bs]
    ;[belib.browser :as bb]
    [grooob.model.model-spec :as ms :refer [example-model get-rand-project-id projects-ids-range resources-ids-range next-sequence-num]]
...
(defn now-date-time []
  (str "CALLED now-date-time in grooob.model at: " (t/instant)))
