...
#_(defn start-conn []
    (mount/start #'grooob.config/env #'grooob.db.core/conn))

#_(defn stop-conn []
    (mount/stop #'grooob.config/env #'grooob.db.core/conn))
...
(comment
  (let [_ (mount/start-with {#'grooob.db.core/conn     (connect-test-db)
                             #'grooob.core/http-server nil
                             #'grooob.core/repl-server nil
                             #'grooob.handler/init-app nil})]
